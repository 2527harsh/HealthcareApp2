...
public class Database extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        String qry3= "create table orderplace(usernmae text,fullname text, address text,contactno text,pincode int,date text,time text,amount float,otype text)";
    ...
    public ArrayList getCartData(String username, String otype){
        ...
        str[0]= username;
        str[1]=otype;
        Cursor c=db.rawQuery("select 8 from cart where username=? and otype=?",str);
        if(c.moveToFirst()){
            do{
